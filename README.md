...
**Tools & Frameworks:** PyTorch · PySpark · React · Docker · Git · JUnit · GHAS · Jira · Vim · VSCode
...
| Project | Description | Tech |
|---------|-------------|------|
| ✈️ [Ground Roll Calculator](https://github.com/Deleted-0970/Ground-Roll-Calculator) | Calculates the takeoff ground roll distance for RC aircraft — born from a love of flying things | Python · Physics |
